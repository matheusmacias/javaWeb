...
--
-- Host: localhost    Database: empresa01
-- ------------------------------------------------------
...
CREATE TABLE `fisica` (
  ...
  UNIQUE KEY `cpf` (`cpf`),
  KEY `FK_Fisica_2` (`fk_Pessoa_id`),
  CONSTRAINT `FK_Fisica_2` FOREIGN KEY (`fk_Pessoa_id`) REFERENCES `pessoa` (`id`) ON DELETE CASCADE
...
CREATE TABLE `juridica` (
  ...
  KEY `FK_Juridica_2` (`fk_Pessoa_id`),
  CONSTRAINT `FK_Juridica_2` FOREIGN KEY (`fk_Pessoa_id`) REFERENCES `pessoa` (`id`) ON DELETE CASCADE
...
CREATE TABLE `pessoa` (
  ...
  `numeroCelular` varchar(13) DEFAULT NULL,
  `numeroTelefone` varchar(13) DEFAULT NULL,
  `cep` varchar(8) DEFAULT NULL,
  `Rua` varchar(100) DEFAULT NULL,
  `complemento` varchar(100) DEFAULT NULL,
  `numeroEnd` varchar(7) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
--
-- Dumping events for database 'empresa01'
--

--
-- Dumping routines for database 'empresa01'
--
...
-- Dump completed on 2022-11-10 21:27:58
